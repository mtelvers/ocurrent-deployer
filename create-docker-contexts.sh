...
docker context create "ci3.ocamllabs.io" --description "Ci3 - OCamlLabs" --docker "host=ssh://root@ci3.ocamllabs.io"
docker context create "ci4.ocamllabs.io" --description "Ci4 - OCamlLabs" --docker "host=ssh://root@ci4.ocamllabs.io"
docker context create "ci.mirage.io" --description "Ci - Mirage" --docker "host=ssh://root@ci.mirage.io"
docker context create "ci.ocamllabs.io" --description "Toxis - OCamlLabs" --docker "host=ssh://root@ci.ocamllabs.io"
...
docker context create "tezos.ci.dev" --description "Tezos CI - OCamlLabs" --docker "host=ssh://root@tezos.ci.dev"
